...
namespace lab_07.GUI
{
    public partial class RefereeForm : Form
    {
        ...
        public RefereeForm(User user, UserService userService, MatchService matchService, LeagueService leagueService, ClubService clubService, FeedbackService feedbackService, ClubStatService clubStatService)
        {
            InitializeComponent();
            this.user = user;
        ...
        {
            openChildForm(new LeagueForm(userService, leagueService, clubService, feedbackService, matchService, clubStatService));
        }
