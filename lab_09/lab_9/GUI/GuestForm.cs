...
namespace lab_07.GUI
{
    public partial class GuestForm : Form
    {
        ...
        public GuestForm(UserService userService, LeagueService leagueService, ClubService clubService, FeedbackService feedbackService, MatchService matchService, ClubStatService clubStatService)
        {
            InitializeComponent();
